...
# Continue button - find by ID
driver.find_element(By.ID, 'continue')

# Conditions of use link - find by XPATH
...
# Privacy Notice link - find by XPATH
...
# Need help link - find byXPATH
driver.find_element(By.XPATH, "//span[@class='a-expander-prompt']")

# Forgot your password link - find by ID
driver.find_element(By.ID, 'auth-fpp-link-bottom')

# Other issues with Sign-In link - find by ID
driver.find_element(By.ID, 'ap-other-signin-issues-link')

# Create your Amazon account button - find by ID
